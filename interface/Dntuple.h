...
{//{{{
 public:
  ...
  float   Dtrk1DxyErr[MAX_XB];
  float   dxyos1[MAX_XB];
  float   dxyos2[MAX_XB];
  float   Dtrk2DxyErr[MAX_XB];
  float   Dtrk3DxyErr[MAX_XB];
  float   Dtrk4DxyErr[MAX_XB];
  float   Dtrk1Dsz[MAX_XB];
  float   Dtrk2Dsz[MAX_XB];
  float   Dtrk3Dsz[MAX_XB];
  float   Dtrk4Dsz[MAX_XB];
  float   Dtrk1DszErr[MAX_XB];
  float   Dtrk2DszErr[MAX_XB];
  float   Dtrk3DszErr[MAX_XB];
  float   Dtrk4DszErr[MAX_XB];
  float   dzos1[MAX_XB];
  float   dzos2[MAX_XB];
  ...
  float   DRestrk1DxyErr[MAX_XB];
  float   DRestrk1Dsz[MAX_XB];
  float   DRestrk1DszErr[MAX_XB];
  ...
  float   DRestrk2DxyErr[MAX_XB];
  float   DRestrk2Dsz[MAX_XB];
  float   DRestrk2DszErr[MAX_XB];
  ...
  float   DRestrk3DxyErr[MAX_XB];
  float   DRestrk3Dsz[MAX_XB];
  float   DRestrk3DszErr[MAX_XB];
  ...
  float   DRestrk4DxyErr[MAX_XB];
  float   DRestrk4Dsz[MAX_XB];
  float   DRestrk4DszErr[MAX_XB];
...
//    dnt->Branch("LumiNo",&LumiNo);
    ...
    dnt->Branch("centrality",&centrality);
/*    dnt->Branch("PVx",&PVx);
    dnt->Branch("PVy",&PVy);
    dnt->Branch("PVz",&PVz);
...
*/
    ...
    dnt->Branch("pTD1",Dtrk1Pt,"pTD1[Dsize]/F");
    //dnt->Branch("Dtrk2Pt",Dtrk2Pt,"Dtrk2Pt[Dsize]/F");
    dnt->Branch("pTD2",Dtrk2Pt,"pTD2[Dsize]/F");
    ...
    //dnt->Branch("Dtrk1DxyErr",Dtrk1DxyErr,"Dtrk1DxyErr[Dsize]/F");
    //dnt->Branch("Dtrk2DxyErr",Dtrk2DxyErr,"Dtrk2DxyErr[Dsize]/F");
    //dnt->Branch("xyDCASignificanceDaugther1",dxyos1,"xyDCASignificanceDaugther1[Dsize]/F");
    //dnt->Branch("xyDCASignificanceDaugther2",dxyos2,"xyDCASignificanceDaugther2[Dsize]/F");
    //dnt->Branch("Dtrk1Dsz",Dtrk1Dsz,"Dtrk1Dsz[Dsize]/F");
    //dnt->Branch("Dtrk2Dsz",Dtrk2Dsz,"Dtrk2Dsz[Dsize]/F");
    //dnt->Branch("Dtrk1DszErr",Dtrk1DszErr,"Dtrk1DszErr[Dsize]/F");
    //dnt->Branch("Dtrk2DszErr",Dtrk2DszErr,"Dtrk2DszErr[Dsize]/F");
    dnt->Branch("zDCASignificanceDaugther1",dzos1,"zDCASignificanceDaugther1[Dsize]/F");
    dnt->Branch("zDCASignificanceDaugther2",dzos2,"zDCASignificanceDaugther2[Dsize]/F");
    ...
    if(!D0kpimode)
      {
        ...
        dnt->Branch("Dtrk3DxyErr",Dtrk3DxyErr,"Dtrk3DxyErr[Dsize]/F");
        dnt->Branch("Dtrk4DxyErr",Dtrk4DxyErr,"Dtrk4DxyErr[Dsize]/F");
        dnt->Branch("Dtrk3Dsz",Dtrk3Dsz,"Dtrk3Dsz[Dsize]/F");
        dnt->Branch("Dtrk4Dsz",Dtrk4Dsz,"Dtrk4Dsz[Dsize]/F");
        dnt->Branch("Dtrk3DszErr",Dtrk3DszErr,"Dtrk3DszErr[Dsize]/F");
        dnt->Branch("Dtrk4DszErr",Dtrk4DszErr,"Dtrk4DszErr[Dsize]/F");
    ...
    if(!D0kpimode)
      {
        ...
        dnt->Branch("DRestrk1DxyErr",DRestrk1DxyErr,"DRestrk1DxyErr[Dsize]/F");
        dnt->Branch("DRestrk1Dsz",DRestrk1Dsz,"DRestrk1Dsz[Dsize]/F");
        dnt->Branch("DRestrk1DszErr",DRestrk1DszErr,"DRestrk1DszErr[Dsize]/F");
        ...
        dnt->Branch("DRestrk2DxyErr",DRestrk2DxyErr,"DRestrk2DxyErr[Dsize]/F");
        dnt->Branch("DRestrk2Dsz",DRestrk2Dsz,"DRestrk2Dsz[Dsize]/F");
        dnt->Branch("DRestrk2DszErr",DRestrk2DszErr,"DRestrk2DszErr[Dsize]/F");
        ...
        dnt->Branch("DRestrk3DxyErr",DRestrk3DxyErr,"DRestrk3DxyErr[Dsize]/F");
        dnt->Branch("DRestrk3Dsz",DRestrk3Dsz,"DRestrk3Dsz[Dsize]/F");
        dnt->Branch("DRestrk3DszErr",DRestrk3DszErr,"DRestrk3DszErr[Dsize]/F");
        ...
        dnt->Branch("DRestrk4DxyErr",DRestrk4DxyErr,"DRestrk4DxyErr[Dsize]/F");
        dnt->Branch("DRestrk4Dsz",DRestrk4Dsz,"DRestrk4Dsz[Dsize]/F");
        dnt->Branch("DRestrk4DszErr",DRestrk4DszErr,"DRestrk4DszErr[Dsize]/F");
  ...
  {//{{{
    ...
    fillTreeEvt(EvtInfo);  //Milan to reduce the size
        ...
        if(isDchannel[t]==1)
          {
            for(int j=0;j<DInfo->size;j++)
              {
                double VtxProb = TMath::Prob(DInfo->vtxchi2[j],DInfo->vtxdof[j]);
                float lvtxMag = TMath::Sqrt((DInfo->vtxX[j]-EvtInfo->PVx)*(DInfo->vtxX[j]-EvtInfo->PVx)+(DInfo->vtxY[j]-EvtInfo->PVy)*(DInfo->vtxY[j]-EvtInfo->PVy)+(DInfo->vtxZ[j]-EvtInfo->PVz)*(DInfo->vtxZ[j]-EvtInfo->PVz));
               b4P->SetPtEtaPhiM(DInfo->pt[j],DInfo->eta[j],DInfo->phi[j],DInfo->mass[j]);
///Milan added selection
                //if( (TrackInfo->pt[DInfo->rftk1_index[j]]+TrackInfo->pt[DInfo->rftk2_index[j]])<1.6  ) continue;
                if( (fabs(TrackInfo->eta[DInfo->rftk1_index[j]] - TrackInfo->pt[DInfo->rftk2_index[j]])) > 1.0  ) continue;
                if (VtxProb < 0.02) continue;
                if (lvtxMag*lvtxMag/DInfo->sigmaLvtxMag[j]<1.0) continue;
                if (DInfo->alpha[j] > 1.) continue;

                //if (DInfo->size > 27 ) continue;
//End Milan selection
                if(skim)
                  {
  ...
  void fillDGenTree(TTree* ntGen, GenInfoBranches *GenInfo, bool gskim=true)
  {
    ...
    for(int j=0;j<GenInfo->size;j++)
      {
        ...
        //std::cout<<" pdg = "<<GenInfo->pdgId[j]<<" "<<GisSignal[gsize]<<std::endl; //Milan
	...
	GdecayvtxZ[gsize] = -999;
        ...
        GRestk4phi[gsize] = -20;
        GRestk4y[gsize] = -1;
        if (fabs(GenInfo->pdgId[j]) == 421 ) cout << GisSignal[gsize] <<" check 0 "<< GenInfo->nDa[j] <<" d1: "<<GenInfo->pdgId[GenInfo->da1[j]]<<" d2: "<<GenInfo->pdgId[GenInfo->da2[j]]<<endl;
        if(GisSignal[gsize]==0||GisSignal[gsize]==1||GisSignal[gsize]==2||GisSignal[gsize]==3||GisSignal[gsize]==4||GisSignal[gsize]==5||GisSignal[gsize]==6)
          {
            ...
            if (fabs(GenInfo->pdgId[j]) == 421) cout << "check some ntuple"<<GenInfo->pt[GenInfo->da1[j]]<<endl;
  ...
  void fillDTree(TVector3* bP, TVector3* bVtx, TLorentzVector* b4P, int j, int typesize, bool REAL, EvtInfoBranches *EvtInfo, VtxInfoBranches *VtxInfo, TrackInfoBranches *TrackInfo, DInfoBranches *DInfo, GenInfoBranches *GenInfo)
  {
    ...
    DdxyzErr[typesize] =  DInfo->dlerror[j];//  TMath::Sqrt(DInfo->vtxXErr[j]*DInfo->vtxXErr[j]+DInfo->vtxYErr[j]*DInfo->vtxYErr[j]+DInfo->vtxZErr[j]*DInfo->vtxZErr[j]);
    dlos[typesize] = Ddxyz[typesize]*Ddxyz[typesize]/DdxyzErr[typesize];
    Dchi2ndf[typesize] = DInfo->vtxchi2[j]/DInfo->vtxdof[j];
    Dchi2cl[typesize] = TMath::Prob(DInfo->vtxchi2[j],DInfo->vtxdof[j]);
    //VtxProb[typesize] = TMath::Prob(DInfo->vtxchi2[j],DInfo->vtxdof[j]);
    ...
    if(DInfo->type[j]==1||DInfo->type[j]==2||DInfo->type[j]==3||DInfo->type[j]==4||DInfo->type[j]==5||DInfo->type[j]==6)
      {
        ...
        Dtrk1DxyErr[typesize] = TrackInfo->dxyErr[DInfo->rftk1_index[j]];
        dxyos1[typesize] = Dtrk1Dxy[typesize]/Dtrk1DxyErr[typesize];
        Dtrk1Dsz[typesize] = TrackInfo->dszPV[DInfo->rftk1_index[j]];
        Dtrk1DszErr[typesize] = TrackInfo->dszErr[DInfo->rftk1_index[j]];
        dzos1[typesize] = Dtrk1Dsz[typesize]/Dtrk1DszErr[typesize];
        ...
        Dtrk2DxyErr[typesize] = TrackInfo->dxyErr[DInfo->rftk2_index[j]];
        dxyos2[typesize] = Dtrk2Dxy[typesize]/Dtrk2DxyErr[typesize];
        Dtrk2Dsz[typesize] = TrackInfo->dszPV[DInfo->rftk2_index[j]];
        Dtrk2DszErr[typesize] = TrackInfo->dszErr[DInfo->rftk2_index[j]];
        dzos2[typesize] = Dtrk2Dsz[typesize]/Dtrk2DszErr[typesize];
        ...
        if(DInfo->type[j]==1||DInfo->type[j]==2)
          {
            ...
            Dtrk3Y[typesize] = -1;
            Dtrk3Dxy[typesize] = -1;
            Dtrk3DxyErr[typesize] = -1;
            Dtrk3Dsz[typesize] = -1;
            Dtrk3DszErr[typesize] = -1;
            ...
            Dtrk4Y[typesize] = -1;
            Dtrk4Dxy[typesize] = -1;
            Dtrk4DxyErr[typesize] = -1;
            Dtrk4Dsz[typesize] = -1;
            Dtrk4DszErr[typesize] = -1;
            ...
            DRestrk1DxyErr[typesize] = -1;
            DRestrk1Dsz[typesize] = -1;
            DRestrk1DszErr[typesize] = -1;
            ...
            DRestrk2DxyErr[typesize] = -1;
            DRestrk2Dsz[typesize] = -1;
            DRestrk2DszErr[typesize] = -1;
            ...
            DRestrk3DxyErr[typesize] = -1;
            DRestrk3Dsz[typesize] = -1;
            DRestrk3DszErr[typesize] = -1;
            ...
            DRestrk4DxyErr[typesize] = -1;
            DRestrk4Dsz[typesize] = -1;
            DRestrk4DszErr[typesize] = -1;
        ...
        else if(DInfo->type[j]==3||DInfo->type[j]==4)
          {
            ...
            Dtrk3DxyErr[typesize] = TrackInfo->dxyErr[DInfo->rftk3_index[j]];
            Dtrk3Dsz[typesize] = TrackInfo->dszPV[DInfo->rftk3_index[j]];
            Dtrk3DszErr[typesize] = TrackInfo->dszErr[DInfo->rftk3_index[j]];
        ...
        else if(DInfo->type[j]==5||DInfo->type[j]==6)
          {
            ...
            Dtrk3DxyErr[typesize] = TrackInfo->dxyErr[DInfo->rftk3_index[j]];
            Dtrk4DxyErr[typesize] = TrackInfo->dxyErr[DInfo->rftk4_index[j]];
            Dtrk3Dsz[typesize] = TrackInfo->dszPV[DInfo->rftk3_index[j]];
            Dtrk4Dsz[typesize] = TrackInfo->dszPV[DInfo->rftk4_index[j]];
            Dtrk3DszErr[typesize] = TrackInfo->dszErr[DInfo->rftk3_index[j]];
            Dtrk4DszErr[typesize] = TrackInfo->dszErr[DInfo->rftk4_index[j]];
            Dtrk3PixelHit[typesize] = TrackInfo->pixelhit[DInfo->rftk3_index[j]];
    ...
    else if(DInfo->type[j]==7||DInfo->type[j]==8||DInfo->type[j]==9||DInfo->type[j]==10||DInfo->type[j]==11||DInfo->type[j]==12||DInfo->type[j]==13||DInfo->type[j]==14)
      {
        ...
        Dtrk1DxyErr[typesize] = TrackInfo->dxyErr[DInfo->rftk2_index[j]];
        Dtrk1Dsz[typesize] = TrackInfo->dszPV[DInfo->rftk2_index[j]];
        Dtrk1DszErr[typesize] = TrackInfo->dszErr[DInfo->rftk2_index[j]];
        ...
        Dtrk2Y[typesize] = -1;
        Dtrk2Dxy[typesize] = -1;
        Dtrk2DxyErr[typesize] = -1;
        Dtrk2Dsz[typesize] = -1;
        Dtrk2DszErr[typesize] = -1;
        ...
        DRestrk1DxyErr[typesize] = TrackInfo->dxyErr[DInfo->tktkRes_rftk1_index[j]];
        DRestrk1Dsz[typesize] = TrackInfo->dszPV[DInfo->tktkRes_rftk1_index[j]];
        DRestrk1DszErr[typesize] = TrackInfo->dszErr[DInfo->tktkRes_rftk1_index[j]];
        ...
        DRestrk2DxyErr[typesize] = TrackInfo->dxyErr[DInfo->tktkRes_rftk2_index[j]];
        DRestrk2Dsz[typesize] = TrackInfo->dszPV[DInfo->tktkRes_rftk2_index[j]];
        DRestrk2DszErr[typesize] = TrackInfo->dszErr[DInfo->tktkRes_rftk2_index[j]];
        ...
        if(DInfo->type[j]==11||DInfo->type[j]==12)
          {
            ...
            DRestrk3DxyErr[typesize] = TrackInfo->dxyErr[DInfo->tktkRes_rftk3_index[j]];
            DRestrk3Dsz[typesize] = TrackInfo->dszPV[DInfo->tktkRes_rftk3_index[j]];
            DRestrk3DszErr[typesize] = TrackInfo->dszErr[DInfo->tktkRes_rftk3_index[j]];
            ...
            DRestrk4DxyErr[typesize] = TrackInfo->dxyErr[DInfo->tktkRes_rftk4_index[j]];
            DRestrk4Dsz[typesize] = TrackInfo->dszPV[DInfo->tktkRes_rftk4_index[j]];
            DRestrk4DszErr[typesize] = TrackInfo->dszErr[DInfo->tktkRes_rftk4_index[j]];
